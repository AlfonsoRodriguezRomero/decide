...
class TestDeleteQuestion():
    ...
    def test_deleteQuestion(self):
        ...
        self.driver.get("http://decide-zapdos-votacion.herokuapp.com/voting/question")
...
class TestCreateQuestion():
    ...
    def test_createQuestion(self):
        ...
        self.driver.find_element_by_css_selector("input[type='submit']").click()
        self.driver.get("http://decide-zapdos-votacion.herokuapp.com/voting/question")
        self.driver.get("http://decide-zapdos-votacion.herokuapp.com/admin/voting/question/add/")
